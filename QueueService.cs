...
public class QueueService : IQueueService
{
    ...
    /// </summary>
    private readonly Channel<IQueueService.WorkItemDelegate> _queue;
    ...
    public QueueService(int capacity = 1024)
    {
        ...
        _queue = Channel.CreateBounded<IQueueService.WorkItemDelegate>(options);
    }
    ...
    public ValueTask PublishAsync(IQueueService.WorkItemDelegate item)
    {
    ...
    public ValueTask<IQueueService.WorkItemDelegate> ConsumeAsync(CancellationToken cancellationToken) =>
